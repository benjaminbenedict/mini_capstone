...
plant_1 = Product.new({ name: "Pink Princess", price: 299, description: "It's a philodendron but with pink!", supplier_id: 2 })
plant_1.save
plant_2 = Product.new({ name: "anthurium crystallinum", price: 70, description: "Heart shaped velvety leaves", supplier_id: 1 })
plant_2.save
plant_3 = Product.new({ name: "Monstera Albo", price: 599, description: "It's a Monstera but with some white!", supplier_id: 3 })
plant_3.save
plant_4 = Product.new({ name: "Philodendron Melanochrysum", price: 100, description: "Velvety leaves with a green back", supplier_id: 2 })
plant_4.save
plant_5 = Product.new({ name: "Philodendron Gloriosum", price: 65, description: "ground creeping with velvety leaves", supplier_id: 1 })
plant_5.save
plant_6 = Product.new({ name: "Begonia Maculata", price: 35, description: "Green angle wing shaped leaves with a red back and white pokadots", supplier_id: 3 })
plant_6.save

Product.create({ name: "philodendron painted lady", price: 55, description: "it p cool bruh", supplier_id: 3 })
